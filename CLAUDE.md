...
## Harness Suite 代码标识规则

**所有新生成的代码文件必须包含 Harness Suite 标识注释**
 ...
 * Generated at: 2026-05-12 10:30:00
 * Change ID: user-login-20260410-01
 * ================================================
 */
```
...
Hook `ensure_harness_header.py` 会在 `Write` 新文件时自动添加标识注释。
